...
function RegisterForm() {
    const handleRegisterAction = (formData: FormData) => {
        ...
        console.log("Register action triggered:", data);
    }
  return (
      <form action={handleRegisterAction} className="space-y-4" style={{ fontFamily: 'var(--font-body)' }}>
          <div>
            <label htmlFor="name" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-ink)' }}>
              Name
            </label>
            <input 
              id="name"
          ...
          <div>
            <label htmlFor="phone" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-ink)' }}>
              Phone
            </label>
            <input 
              id="phone"
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium mb-1" style={{ color: 'var(--color-ink)' }}>
              Password
            </label>
            <input 
              id="password"
