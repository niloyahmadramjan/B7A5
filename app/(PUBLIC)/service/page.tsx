    ...
    data: [
      {
        ...
        description:
          "Complete AC servicing, deep jet wash cleaning, and gas leak inspection by certified HVAC techs.",
        price: 500,
        duration: 180,
        rating: 4.9,
        reviewsCount: 38,
      ...
      },
      {
        ...
        description:
          "Comprehensive circuit breaker test, short-circuit diagnostic, and grounding inspection.",
        price: 1200,
        duration: 120,
        rating: 4.8,
        reviewsCount: 19,
      ...
      },
      {
        ...
        description:
          "Emergency high-pressure plumbing repair, fixture replacement, and line clog clearing.",
        price: 800,
        duration: 90,
        rating: 5.0,
        reviewsCount: 52,
      ...
      },
      {
        ...
        description:
          "Professional replacement of non-functional inverter compressor with manufacturer warranty.",
        price: 3500,
        duration: 240,
        rating: 4.7,
        reviewsCount: 14,
      ...
      },
      {
        ...
        description:
          "Quick installation and load balancing for smart ceiling fans, chandeliers, and LED fixtures.",
        price: 350,
        duration: 45,
        rating: 4.9,
        reviewsCount: 61,
...
export default function ServicesPage() {
  ...
  const categories = useMemo(() => {
    const cats = MOCK_API_RESPONSE.data.data.map(
      (item) => item.categoryName || "General",
    );
    ...
    >
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          ...
          {/* Price Range Slider */}
          <div
            className="pt-2 border-t flex flex-col sm:flex-row items-center justify-between gap-4"
        ...
        <Pagination
          meta={{
            ...
            totalPages:
              Math.ceil(
                filteredServices.length / MOCK_API_RESPONSE.data.meta.limit,
              ) || 1,
          }}
